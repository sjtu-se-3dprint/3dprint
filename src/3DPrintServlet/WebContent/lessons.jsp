...
<body>
	...
	<%
		...
		Lesson lesson = LessonService.getModelService().selectLessonById(id);
		System.out.println(lesson.getAddtime());
		System.out.println(lesson.getId());
		System.out.println(lesson.getUserID());
		List<LessonDetail> details = LessonService.getModelService().selectLessonDetailByLessonId(id);
			...
			<div class="span12">
				<div class="row">
					<div class="span8" style="padding-left: 10px;">
						...
						<h3 style="text-align: center;">&nbsp;&nbsp; <%=lesson.getTitle() %></h3>
						<ul class="tp1">
					...
					<div class="span8"
						...
						<%
							for(LessonDetail detail:details){
								out.println("<p style=\"text-indent:2em\">");
								if("txt".equals(detail.getType())){
									out.println(detail.getTxt());
								}else if("img".equals(detail.getType())){
									out.println("<div style=\"text-align:center\"><img src=\"ajax/lessonimage?detailID=" + detail.getId() + "\"></div>");
								}else if("video".equals(detail.getType())){
									String video = "<embed src=\"" + detail.getVideoUrl() + "\"" +
						...
						%>
						<div id="editor">(责任编辑：shuying)</div>
					</div>
					<div class="span3">
						<div class="thumbnail" style="background-color: #a9dba9">
							<div class="caption">
								<span class="title" style="float: left;">教程系列</span> <a
									href="ST_3Dprint.jsp" style="float: right;">更多>></a>
							</div>
							<hr>
							<div class="caption">
								<a href="ST_3Dprint.jsp"> <span> 什么是3D打印 </span></a>
							</div>
							<div class="caption">
								<a href="ST_3Dprint.jsp"> <span> 3D打印基于微分原理 </span></a>
							</div>
							<div class="caption">
								<a href="ST_3Dprint.jsp"> <span> 3D打印基于微分原理 </span></a>
							</div>
						...
						<div class="row"
							...
							<div class="span12" style="padding-right: 8px;">
								<img alt="jiaocheng" src="./img/glass2.gif"
									style="float: left; height: 80px; width: 100px;" /> <img
									alt="jiaocheng" src="./img/glass2.gif"
									style="float: right; height: 80px; width: 100px;" />
							</div>
							<div class="span12" style="margin-top: 8px">
								<ul class="unstyled" style="margin-left: 40px;">
									<li><h4>
											<a href="study.jsp">教程名字名字名字</a>
										</h4></li>
									<li><h4>
											<a href="study.jsp">新闻资讯</a>
										</h4></li>
									<li><h4>
											<a href="study.jsp">新闻资讯</a>
										</h4></li>
				...
				<div class="row">
					<div class="span8"
						...
						<h4>
							上一篇：<a href="">3D打印入门教程三：3D打印的应用</a>
						</h4>
						<h4>
							下一篇：<a href="">3D打印入门教程五：立体光雕刻打印机</a>
						</h4>
					</div>
					<div class="span4"></div>
				</div>
